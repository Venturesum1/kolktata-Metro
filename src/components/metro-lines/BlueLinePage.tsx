...
const BlueLinePage = () => {
  const blueLineStations = [
    ...
    "Shobhabazar Sutanuti", "Girish Park", "Mahatma Gandhi Road", "Central", "Chandni Chowk", "Esplanade",
    "Park Street", "Maidan", "Rabindra Sadan", "Netaji Bhavan", "Jatin Das Park", "Kalighat",
    "Rabindra Sarobar", "Mahanayak Uttam Kumar", "Netaji", "Masterda Surya Sen", "Kavi Subhash"
  ];
  ...
  const attractions = [
    ...
    { name: "Shobhabazar Rajbari", station: "Shobhabazar Sutanuti", distance: "0.4 km" },
    { name: "Netaji Bhavan Museum", station: "Netaji Bhavan", distance: "0.1 km" }
  ];
      ...
      <div className="bg-gradient-to-r from-metro-blue to-metro-blue/80 text-white py-8 sm:py-10 md:py-12 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 md:gap-4">
            ...
            <Badge className="bg-white/20 text-white text-xs sm:text-sm">32.25 KM Long</Badge>
            <Badge className="bg-white/20 text-white text-xs sm:text-sm">23 Stations</Badge>
              ...
              <CardContent className="space-y-4 sm:space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div className="bg-blue-50 p-4 sm:p-6 rounded-lg text-center">
                    ...
                    <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2">32.25 KM Network</h3>
                  ...
                  <div className="bg-blue-50 p-4 sm:p-6 rounded-lg text-center sm:col-span-2 lg:col-span-1">
                    ...
                    <p className="text-sm sm:text-base text-gray-600">41 years of reliable service</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  {blueLineStations.map((station, index) => (
                    <div key={index} className="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                      ...
                      {(station === "Central" || station === "Esplanade") && <Badge className="ml-auto bg-orange-100 text-orange-700 text-xs">Interchange</Badge>}
                    </div>
                  ))}
                </div>
              </CardContent>
